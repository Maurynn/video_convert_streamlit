...
st.markdown("<h1 style='text-align: center; color: cyan;'>📽️ VIDEO CONVERTER  🎶</h1>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: right; color: cyan;'>Online</h4>", unsafe_allow_html=True)
