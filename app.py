...
Desculpe pelo erro anterior, eu fiz uma pequena confusão com o fluxo do código. Aqui está a correção. Agora, se houver algum erro durante o download do vídeo do YouTube, a função `download_youtube_video` retornará `None` e as partes do código que dependem do vídeo baixado serão puladas.
...
if youtube_link:
    video_file_path = download_youtube_video(youtubePeço desculpas, o texto foi cortado. Aqui está o resto:
